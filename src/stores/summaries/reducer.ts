...
export interface SummariesState {
  ...
  [SummaryCollections.ProductCategory]: SummaryCollectionState<ProductCategory>;
...
export const summariesReducer = combineReducers<SummariesState>({
  ...
  [SummaryCollections.ProductCategory]: createSummariesReducer(SummaryCollections.ProductCategory),
