...
/** From T, pick a set of properties whose keys are in the union K */
export class CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ implements ICreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ {
    /** Date at which this entity has been created */
    createdAt!: Date;
    /** Date at which this entity has last been updated */
    updatedAt!: Date;
...
/** From T, pick a set of properties whose keys are in the union K */
export class CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_ implements ICreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_ {
    /** Label of the file as shown in the front-end */
    name!: string;
    /** Date at which this entity has been created */
    createdAt!: Date;
...
export class ProductInstanceGDPRResponse extends NameDutchOrNameEnglish_ implements IProductInstanceGDPRResponse {
    ...
    static fromJS(data: any): ProductInstanceGDPRResponse {
        data = typeof data === 'object' ? data : {};
...
export class ContractGDPRResponse extends Title_ implements IContractGDPRResponse {
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["products"])) {
                this.products = [] as any;
                for (let item of _data["products"])
                    this.products!.push(ProductInstanceGDPRResponse.fromJS(item));
            }
            if (Array.isArray(_data["files"])) {
                this.files = [] as any;
                for (let item of _data["files"])
    ...
    static fromJS(data: any): ContractGDPRResponse {
        data = typeof data === 'object' ? data : {};
...
export class InvoiceGDPRResponse extends title_ implements IInvoiceGDPRResponse {
    products!: ProductInstanceGDPRResponse[];
    files!: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
    ...
    static fromJS(data: any): InvoiceGDPRResponse {
        data = typeof data === 'object' ? data : {};
...
export interface IInvoiceGDPRResponse extends Ititle_ {
    products: ProductInstanceGDPRResponse[];
    files: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
    activities: activities2[];
    assignedToYou: boolean;
...
export class Activities extends CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ implements IActivities {
    /** Subtype of this activity, only used when the type = "STATUS" */
    subType!: ProductInstanceStatus | undefined;
...
export class activities2 extends CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ implements Iactivities2 {
    /** Subtype of this activity, only used when the type = "STATUS" */
    subType!: InvoiceStatus | undefined;
    ...
    static fromJS(data: any): activities2 {
        data = typeof data === 'object' ? data : {};
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["invoices"])) {
                this.invoices = [] as any;
                for (let item of _data["invoices"])
                    this.invoices!.push(InvoiceGDPRResponse.fromJS(item));
            }
            if (Array.isArray(_data["contracts"])) {
                this.contracts = [] as any;
                for (let item of _data["contracts"])
                    this.contracts!.push(ContractGDPRResponse.fromJS(item));
            }
            if (Array.isArray(_data["files"])) {
                this.files = [] as any;
                for (let item of _data["files"])
            ...
            if (Array.isArray(_data["activities"])) {
                this.activities = [] as any;
                for (let item of _data["activities"])
                    this.activities!.push(CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_.fromJS(item));
            }
        }
    }
