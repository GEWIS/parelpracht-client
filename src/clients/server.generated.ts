...
export class Client {
  ...
  updateCompanyActivity(id: number, activityId: number, body: Partial_ActivityParams_): Promise<BaseActivity> {
    ...
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace('{id}', encodeURIComponent('' + id));
    if (activityId === undefined || activityId === null) throw new Error("The parameter 'activityId' must be defined.");
  ...
  updateProductInstanceOnContract(
    ...
    if (id === undefined || id === null) throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace('{id}', encodeURIComponent('' + id));
    if (prodId === undefined || prodId === null) throw new Error("The parameter 'prodId' must be defined.");
...
export class Product implements IProduct {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.instances)) {
      data['instances'] = [];
      for (let item of this.instances) data['instances'].push(item.toJSON());
    }
    if (Array.isArray(this.activities)) {
      data['activities'] = [];
      for (let item of this.activities) data['activities'].push(item.toJSON());
