...
export class Client {
     ...
     * @return Ok
     */
    updateActivity(id: number, activityId: number, body: Partial_UpdateActivityParams): Promise<BaseActivity> {
     ...
     * @return Ok
     */
    updateActivity2(id: number, activityId: number, body: Partial_UpdateActivityParams): Promise<BaseActivity> {
     ...
     * @return Ok
     */
    updateProductActivity(id: number, prodId: number, activityId: number, body: Partial_UpdateActivityParams): Promise<BaseActivity> {
     ...
     * @return Ok
     */
    updateActivity3(id: number, activityId: number, body: Partial_UpdateActivityParams): Promise<BaseActivity> {
     ...
     * @return Ok
     */
    updateActivity4(id: number, activityId: number, body: Partial_UpdateActivityParams): Promise<BaseActivity> {
...
/** Make all properties in T optional */
export class Partial_UpdateActivityParams implements IPartial_UpdateActivityParams {
    description?: string;
    relatedEntityId?: number;

    constructor(data?: IPartial_UpdateActivityParams) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Partial_UpdateActivityParams {
        data = typeof data === 'object' ? data : {};
        let result = new Partial_UpdateActivityParams();
        result.init(data);
        return result;
    }
...
/** Make all properties in T optional */
export interface IPartial_UpdateActivityParams {
    description?: string;
    relatedEntityId?: number;
}
